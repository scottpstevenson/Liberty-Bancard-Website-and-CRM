...
- **Lead File Imports**: 62,556 leads imported from 7 files (Google Maps scraper CSV/XLSX, 43K lead file, CC Leads June, CC Leads Automotive, 26K Brands). Auto-classified into 20 verticals. Import script: `server/scripts/import-leads.ts`. Sources tracked via `lead_source` column.
