...
const DEFAULT_COLLATERAL_PACKETS = [
  {
    ...
    vertical: null,
    tags: ["wholesale"],
    pages: ["wholesale-overview", "rate-comparison", "statement-sample"],
    description: "Standard wholesale pricing overview for cost-plus merchants",
    isActive: true,
  },
  {
    ...
    pages: ["zero-percent-overview", "compliance-guide", "terminal-options"],
    description: "Cash discount / surcharge program overview",
    isActive: true,
  },
  {
    ...
    pages: ["terminal-catalog", "pricing-overview", "setup-guide"],
    description: "Terminal equipment options and setup information",
    isActive: true,
  },
  {
    ...
    pages: ["beat-square-stripe", "rate-comparison", "feature-comparison"],
    description: "Head-to-head comparison against flat-rate processors",
    isActive: true,
  },
  {
    ...
    pages: ["healthcare-overview", "compliance-hipaa", "terminal-options"],
    description: "Healthcare-specific processing solutions",
    isActive: true,
  },
  {
    ...
    pages: ["restaurant-overview", "pos-options", "tip-adjustment"],
    description: "Restaurant and food service processing solutions",
    isActive: true,
  },
];
