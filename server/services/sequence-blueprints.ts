...
export const RAW_SEQUENCES: RawSequence[] = [
  ...
  { id: "payment-stack-101", name: "Payment Stack 101 — Education", category: "education", trigger: "New merchant onboarded — tag LB-EDUCATION-PAYSTACK added" },
  { id: "pci-security", name: "PCI & Security — Education", category: "education", trigger: "Merchant flagged for PCI education — tag LB-EDUCATION-PCI added" },
