...
export function getAllowedTransitions(stage: string): string[] {
  const transitions: Record<string, string[]> = {
    ...
    "QUALIFIED": ["OUTREACH_EMAIL", "OUTREACH_SMS", "OUTREACH_CALL", "NURTURE", "DEAD"],
    "OUTREACH_EMAIL": ["OUTREACH_SMS", "OUTREACH_CALL", "ENGAGED", "NURTURE", "DEAD"],
    "OUTREACH_SMS": ["OUTREACH_CALL", "ENGAGED", "NURTURE", "DEAD"],
    "OUTREACH_CALL": ["ENGAGED", "MEETING_SET", "NURTURE", "DEAD"],
