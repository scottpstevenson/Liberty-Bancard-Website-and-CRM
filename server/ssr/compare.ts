...
export const COMPETITOR_DATA: Record<string, CompetitorData> = {
  ...
  "authorize-net": {
    ...
    libertyPros: ["No separate $25/month gateway fee", "Interchange-plus pricing shows exact cost breakdown", "Dedicated local rep included", "Free statement analysis before you switch", "0% processing programs available"],
