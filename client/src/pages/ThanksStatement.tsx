...
import { Calendar, Calculator, BarChart3, Send, MessageSquare, CheckCircle, Clock, Phone, Users, ArrowRight, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col font-body">
      ...
      <main className="flex-grow pt-28">
        ...
        <section className="bg-background py-16" data-testid="section-thanks-statement-next">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { icon: Calculator, step: "Step 1", title: "We Calculate Your Rate", desc: "Your true effective rate - total fees divided by total volume. The one number that tells the truth.", time: "Happening now" },
                { icon: BarChart3, step: "Step 2", title: "We Find the Cost Drivers", desc: "Card mix, downgrades, monthly add-ons, batch fees, PCI charges - everything that's inflating your cost.", time: "Within hours" },
                { icon: Send, step: "Step 3", title: "You Get Clear Options", desc: "2-3 paths forward with apples-to-apples math. No vague promises. You keep the breakdown either way.", time: "Same day" },
              ].map((item, i) => (
                <Card key={i} data-testid={`card-next-step-${i + 1}`}>
        ...
        <section className="bg-muted/30 py-16" data-testid="section-thanks-statement-while-waiting">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="bg-background py-12" data-testid="section-thanks-statement-referral">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
