/**
 * Rep Account Activation Page
 *
 * Reached via the one-time invite link sent by POST /api/activation/provision-rep:
 *   /activate-rep#token=<opaque_bearer>
 *
 * Flow:
 *   1. Capture token from URL hash (captureAuthActionToken)
 *   2. Validate against POST /api/auth/agent-invite/validate
 *   3. Show a set-password form
 *   4. POST /api/auth/agent-invite/activate — sets password, creates session
...
export default function ActivateRepAccount() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        {pageState === "invalid" && (
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                This invitation link is invalid or has expired. Rep account invitations are valid for 72 hours.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-sm text-muted-foreground">
                Contact your Liberty Bancard admin to request a new invitation.
              </p>
            </CardContent>
          </Card>
        )}
        ...
        {pageState === "form" && (
          <Card>
            <CardHeader>
              <CardTitle>Activate Your Rep Account</CardTitle>
              <CardDescription>Set a password to access the Liberty Bancard dashboard.</CardDescription>
            </CardHeader>
            <CardContent>
