...
export const SEO_ROUTE_DEFAULTS: Record<string, SeoRouteDefault> = {
  ...
  "/equipment": { title: "POS Terminals & Equipment", description: "Clover, Dejavoo, PAX, and Valor terminals plus virtual terminal access. Buy outright — no leases, no junk fees.", ogTemplate: "default", inSitemap: true },
