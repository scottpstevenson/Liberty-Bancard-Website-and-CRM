...
export const SEO_ROUTE_DEFAULTS: Record<string, SeoRouteDefault> = {
  ...
  "/partners/cpa": { title: "CPA Partner Program — Earn Residuals on Client Referrals | Liberty Bancard", description: "CPAs: your clients are overpaying on processing fees. Refer them to Liberty Bancard and earn 30% lifetime residual income. No sales effort required — just a referral.", ogTemplate: "default", inSitemap: true },
  "/partners/bookkeeper": { title: "Bookkeeper Partner Program — Earn Residuals Referring Clients | Liberty Bancard", description: "Bookkeepers: you reconcile statements monthly and see the fees firsthand. Refer clients to Liberty Bancard and earn 30% lifetime residual income with zero ongoing effort.", ogTemplate: "default", inSitemap: true },
  "/partners/insurance": { title: "Insurance Agent Partner Program — Earn Residuals on Business Referrals | Liberty Bancard", description: "Business insurance agents: you talk to every small business. Introduce them to cash discount payment processing and earn 30% lifetime residuals. Zero payments expertise required.", ogTemplate: "default", inSitemap: true },
